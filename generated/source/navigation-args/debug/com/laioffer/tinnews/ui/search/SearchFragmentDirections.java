...
public class SearchFragmentDirections {
  ...
  @NonNull
  public static ActionNavigationSearchToNavigationDetails actionNavigationSearchToNavigationDetails(
      @NonNull Article article) {
    return new ActionNavigationSearchToNavigationDetails(article);
  }

  public static class ActionNavigationSearchToNavigationDetails implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionNavigationSearchToNavigationDetails(@NonNull Article article) {
      if (article == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionNavigationSearchToNavigationDetails setArticle(@NonNull Article article) {
      if (article == null) {
        throw new IllegalArgumentException("Argument \"article\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("article", article);
    ...
    public int getActionId() {
      return R.id.action_navigation_search_to_navigation_details;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionNavigationSearchToNavigationDetails that = (ActionNavigationSearchToNavigationDetails) object;
    ...
    public String toString() {
      return "ActionNavigationSearchToNavigationDetails(actionId=" + getActionId() + "){"
          + "article=" + getArticle()
          + "}";
    }
  }
