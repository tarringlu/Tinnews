...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull TextView appHeader,
      @NonNull View delimiter, @NonNull FragmentContainerView navHostFragment,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, appHeader, delimiter, navHostFragment,
          navView);
    }
